...
namespace Services
{
    public class PersonService : IPersonService
    {
        ...
        public PersonResponse UpdatePerson(UpdatePersonDto? personToUpdate)
        {
            ...
            Person? person_from_list = _dbContext.Persons.FirstOrDefault(person => person.Id == personToUpdate.Id);
        ...
        public bool DeleteById(Guid? id)
        {
            ...
            Person? person = _dbContext.Persons.FirstOrDefault(person => person.Id == id);
